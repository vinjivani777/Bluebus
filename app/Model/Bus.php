...
class Bus extends Model
{
    ...
    protected $fillable=['id', 'route_id', 'bus_type_id', 'amenities_id', 'bus_name', 'bus_reg_no', 'starting_point', 'start_time', 'ending_point', 'ending_time', 'max_seats','total_fare', 'status', 'created_by','created_id','dates'];
