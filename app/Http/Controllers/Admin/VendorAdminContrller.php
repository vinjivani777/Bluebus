...
class VendorAdminContrller extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('admin.vendoradmin-details.index',['data'=>$data]);
    }
    ...
    {
        return view('admin.vendoradmin-details.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.vendoradmin-details.edit',['edit'=>$edit]);
    }
