...
*/
    ...
    Route::group(['prefix' => 'admin','middleware' =>'adminauth'], function() {
        ...
        //  Banner Setting
        Route::get('banner','Admin\BannersController@index')->name('banner');
        Route::get('banner/create','Admin\BannersController@create')->name('banner.add');
        Route::post('banner/store','Admin\BannersController@store')->name('banner.store');
        Route::get('banner/edit/{id}','Admin\BannersController@edit')->name('banner.edit');
        Route::post('banner/update/{id}','Admin\BannersController@update')->name('banner.update');
        Route::get('banner/destroy','Admin\BannersController@destroy')->name('banner.destroy');
    ...
    Route::post('/filter','Web\SearchController@filter')->name('filter');
    Route::post('/view-seate','Web\SearchController@viewSeate')->name('viewseate');
    Route::post('/select-broadpoint-droppoint','Web\SearchController@BroadDropPoint')->name('select.broadpoint.droppoint');
    Route::post('/user-contect','Web\SearchController@usercontect')->name('user.contect');
    ...
    //Enter UserDetails
    Route::get('user','Web\UserDetailsController@index')->name('web.user');
    Route::get('unsubscribe/{user}','Web\UserDetailsController@user')->name('unsubscribe');
    Route::post('promo.validate','Web\UserDetailsController@promovalidate')->name('promo.validate');
    Route::post('passanger-details','Web\UserDetailsController@passngerdetails')->name('passanger.details');
    Route::post('passanger-details-store','Web\UserDetailsController@passanger')->name('passanger.details.store');
    Route::get('payment','Web\UserDetailsController@payment')->name('payment');
    Route::get('payment-view/','Web\UserDetailsController@paymentview')->name('payment.view');
