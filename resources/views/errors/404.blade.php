...
<!-- Mirrored from coderthemes.com/ubold/layouts/light/pages-404.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Jan 2019 11:44:23 GMT -->
<head>
        <meta charset="utf-8" />
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-white-50">Return to <a href="{{route('web.index')}}" class="text-white ml-1"><b>Home</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
