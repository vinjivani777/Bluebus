...
<!-- Mirrored from coderthemes.com/ubold/layouts/light/email-templates-billing.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Jan 2019 11:45:23 GMT -->
<head>
                        ...
                        <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                            <td class="content-block"
                                ...
                                <h2 class="aligncenter"
                                    ...
                                    align="center">
                                    <a href="#" style="display: block;margin-bottom: 10px;"> <img src="../assets/images/logo-dark.html" height="20" alt="logo"/></a> <br/>
                                    Thanks for Booking  With  HappyJourney</h2>
                            </td>
                        </tr>
                        <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                ...
                                <table class="invoice"
                                    ...
                                    <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                        <td style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 5px 0;"
                                            valign="top"><b>HappyJourney</b><br
                                                style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;"/>Ticket No
                                            #12345<br
                                                    style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;"/>Journey Date
                                            01 2018
                                        </td>
                                    </tr>
                                    <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
