    ...
    <div class="row">
        <div class="col-lg-4 col-xl-4">
            <div class="card-box text-center">
                ...
                @if (($agent_details->profile_picture) == "")
                <img src="{{  asset('admin/images/admin.png')  }}" class="rounded-circle avatar-lg img-thumbnail"alt="profile-image">
                @else
                <img src="{{  asset($agent_details->profile_picture)  }}" class="rounded-circle avatar-lg img-thumbnail"alt="profile-image">
                @endif

                <h4 class="mb-0">{{ $agent_details->username }}</h4>
                <p class="text-muted">bluebus</p>

                <div class="text-left mt-3">
                    <h4 class="font-13 text-uppercase">About Me :</h4>
                    <p class="text-muted mb-2 font-13"><strong>Full Name :</strong> <span class="ml-2">{{ Auth::guard('agent')->user()->username }}</span></p>

                    <p class="text-muted mb-2 font-13"><strong>Mobile :</strong><span class="ml-2">{{ $agent_details->mobile_no }}</span></p>

                    <p class="text-muted mb-2 font-13"><strong>Email :</strong> <span class="ml-2 ">{{ $agent_details->email }}</span></p>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="username" name="username" value="{{ $agent_details->username }}" placeholder="Enter first name">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="adminemail" name="email" value="{{ $agent_details->email }}" placeholder="Enter email">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" class="form-control" id="mobileno" name="mobile_no" value="{{ $agent_details->mobile_no }}" placeholder="Enter password">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="mt-3">
                                                <input type="hidden" name="old_profile" value="{{ $agent_details->profile_picture }}">
