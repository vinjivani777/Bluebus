    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('vendoradmin-detail.update',['id'=>$edit->id])}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-12 col-md-12 ">
                                <h4 class="card-title mt-0 mb-0">Edit Vendor Details</h4>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-6 col-md-6 col-lg-6 col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" required value="{{$edit->username}}" class="form-control" name="username" id="user_name" placeholder="User Name">
                                </div>
                            </div>
                            <div class="col-6 col-md-6 col-lg-6 col-sm-4">
                                <div class="form-group">
                            ...
                            <div class="col-6 col-md-6 col-lg-6 col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control" value="{{$edit->state}}" name="state" id="state" placeholder="State">
                                </div>
                            </div>
                        </div>
                        <div class="row">
