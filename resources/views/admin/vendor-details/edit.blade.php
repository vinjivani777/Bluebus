            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Vendor Details Edit</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('vendor-detail.update',['id'=>$edit->id])}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <input type="hidden" value="{{ $edit->avatar }}" name="old_img"> 
                        ...
                        <div class="row">
                            <div class="col-4 col-md-4 col-lg-4 col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control" name="username" id="username" value="{{ $edit->username }}" placeholder="User Name">
                                </div>
                            </div>
                            <div class="col-4 col-md-4 col-lg-4 col-sm-4">
                                <div class="form-group">
                                    <label for="password">Password</label>
                                    <input type="password" required class="form-control bg-light" readonly disabled="true"  name="password" id="password" placeholder="Password Can't Edit ">
                                </div>
                            </div>
                            <div class="col-4 col-md-4 col-lg-4 col-sm-4">
                                <div class="form-group">
                                    <label for="email">Email</label>
                                    <input type="text" required class="form-control" name="email" id="email" placeholder="Email" value="{{ $edit->email }}">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-4 col-md-4 col-lg-4 col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control" name="first_name" id="first_name" placeholder="First Name" value="{{ $edit->first_name }}">
                                </div>
                            </div>
                            <div class="col-4 col-md-4 col-lg-4 col-sm-4 ">
                                <div class="form-group">
                                    <label for="last_name">Last Name</label>
                                    <input type="text" required class="form-control" name="last_name" id="last_name" placeholder="Last Name" value="{{ $edit->last_name }}">
                                </div>
                            </div>
                            <div class="col-4 col-md-4 col-lg-4 col-sm-4">
                                <div class="form-group">
                                    <label for="phone_number">Phone Number</label>
                                    <input type="number" required class="form-control" name="phone_number" id="phone number" placeholder="Phone Number" value="{{ $edit->mobile_no }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
