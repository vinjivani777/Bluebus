            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Agent Details Add</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('agent-detail.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 col-md-6 col-lg-6 col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control" name="country" id="country" placeholder="Country">
                                </div>
                            </div>
                            <div class="col-6 col-md-6 col-lg-6 col-sm-">
                                <div class="form-group">
                                    <label for="img">Display Image</label>
                                    <input type="file" required class="form-control" name="agent_img" id="agent_img">
                                </div>
                            </div>
                        </div>
                        <div class="row">
