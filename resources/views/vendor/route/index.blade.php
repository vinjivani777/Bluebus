        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{ route('vendor.route-detail.add') }}" class="btn btn-primary mb-2" ><i class="fas fa-plus mr-1"></i> Add New Route</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('vendor.route-detail.edit',['id'=>$route->id]) }}" class="mr-1 text-primary"><i class=" far fa-edit"></i></a>
    ...
    <script>
        $('.remove_route').click(function(){
            ...
            swal({
                ...
                if (result.value) {
                        $.ajax({
                            url:'{{route('vendor.route-detail.destroy')}}',
                            data:{
                                id : c_id
                            },
                            type:'get',
