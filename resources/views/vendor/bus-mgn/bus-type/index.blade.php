    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('vendor.bus-type.add')}} " method="post">
                        <div class="row">
                            @csrf
                        ...
                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="10">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('vendor.bus-type.edit',['id'=>$item->id]) }}" class="mr-1 text-primary"><i class=" far fa-edit"></i></a>
    ...
    <script>
        ...
        $('.remove_bus').click(function(){
            ...
            swal({
                ...
                if (result.value) {
                        $.ajax({
                            url:'{{route('vendor.bus-type.destroy')}}',
                            data:{
                                id : c_id
                            },
                            type:'get',
