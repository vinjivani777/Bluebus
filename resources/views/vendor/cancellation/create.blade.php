    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('vendor.cancellation-detail.store') }}" method="post">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 col-md-6 col-lg-6 col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="cancel_time" value="{{ old('cancel_time') }}" id="board_time" placeholder="Cancel Time">
                                </div>
                            </div>
                            <div class="col-6 col-md-6 col-lg-6 col-sm-4">
                                <div class="form-group">
                                    <label for="percentage">Percentage</label>
                                    <input type="text" class="form-control" name="percentage" value="{{ old('percentage') }}" id="percentage" placeholder="Percentage">
                                </div>
                            </div>
                            <div class="col-6 col-md-6 col-lg-6 col-sm-4">
                                <div class="form-group">
                                    <label for="flat">Flat</label>
                                    <input type="text" class="form-control" name="flat" id="flat" value="{{ old('flat') }}" placeholder="Flat">
                                </div>
                            </div>
                            <div class="col-6 col-md-6 col-lg-6 col-sm-4">
