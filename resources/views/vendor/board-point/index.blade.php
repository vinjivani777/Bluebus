        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{ route('vendor.board-point.add') }}" class="btn btn-primary mb-2" ><i class="fas fa-plus mr-1"></i> Add New Board Point</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('vendor.board-point.edit',['id'=>$board->id]) }}" class="mr-1 text-primary"><i class=" far fa-edit"></i></a>
...
<script>
    ...
    $('.remove_board_point').click(function(){
        ...
        swal({
            ...
            if (result.value) {
                    $.ajax({
                            url:'{{route('vendor.board-point.destroy')}}',
                        data:{
                            id : c_id
                        },
                        type:'get',
