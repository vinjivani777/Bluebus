...
@section('content')
    ...
    <div class="main-content">
            ...
            <div class="container">
                <div class="row mt-5">
                    <div class="col-12 text-center">
                        <div style="font-weight:100;letter-spacing: 2px;font-size:35px;">CANCELLATION</div>
                    </div>
                </div>
                <div class="row mt-1">
                    <div class="col-12 text-center">
                        <div style="font-weight:100;letter-spacing: 2px;font-size:20px;font-family: Montserrat;">Verify your details, and <span class="text-danger">Cancel</span> your tickets</div>
                    </div>
                </div>
                <div class="row">
        ...
        <div class="mini-print" >
            <div class="row">
                <div class="col-12">
                    <div class="display-block bg-dark text-white text-center">CANCELTION</div>
                </div>
            </div>
